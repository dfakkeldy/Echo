...
`Built neurodivergent-first. Smart Rewind handles attention drift, and hands-free bookmarking lets you save thoughts without breaking focus. 100% private.`

### Tailored App Description (2,250 Chars)
```text
Stop fighting your attention span. Echo is an open-source audiobook study player designed specifically for ADHD, AuDHD, and minds that process information differently. Built by a neurodivergent developer who needed a better way to learn, Echo helps you stay engaged, capture thoughts instantly, and recover gracefully when your focus drifts.

WHY ECHO WORKS FOR ADHD & AUDHD:

1. SMART REWIND (THE FOCUS SAVER)
Attention isn't a constant stream—it comes and goes. When you pause the audio to process a thought or because you got distracted, Echo automatically rewinds by a short, intelligent amount based on how long you were paused. You never have to scrub back to find where your mind drifted. You simply resume, and the context is rebuilt for you.

2. ONE-TAP INSTANT BOOKMARKING
Got a sudden insight? Don't break your flow by opening a notes app or unlocking your phone. Tap one button on the player or your Apple Watch to bookmark the exact audio timestamp. Attach a quick voice memo or snap a photo of a reference sheet without ever pausing the audio. 

3. ZERO DISTRACTIONS, ABSOLUTE PRIVACY
Most modern apps compete for your dopamine with notifications, ads, and telemetry. Echo has none of them. There are no accounts to create, no tracking SDKs, no cloud servers, and no notifications. It is a calm, quiet utility that respects your attention.

4. DOCK-DRIVEN SIMPLICITY
The interface is designed to reduce executive function load. There are no deep menus or confusing settings. Your active book, recent bookmarks, and daily review cards are all accessible in a single, thumb-friendly tap dock at the bottom of the screen.

WHO IT'S FOR:
- Students with ADHD who struggle to finish reading assignments.
- AuDHD individuals who learn best by pairing audio with visual markers.
- Anyone looking for a calm, private, and customizable player to learn at their own pace.
```
...
2.  **Slide 2: Smart Rewind**
    *   *Caption:* "Smart Rewind recovers focus. Automatically rewinds a few seconds when you pause."
    *   *Visual:* Close-up of the player showing the Smart Rewind setting popover.
3.  **Slide 3: One-Tap Bookmarks**
    *   *Caption:* "One-tap audio bookmarks. Record quick voice notes and photos without stopping playback."
    *   *Visual:* Bookmark editor sheet overlaying the player, showing an audio wave draft.
4.  **Slide 4: Watch App Integration**
    *   *Caption:* "Hands-free study on Apple Watch. Save bookmarks and review flashcards on the go."
    *   *Visual:* Apple Watch mockup displaying the large, simple bookmark button.
5.  **Slide 5: Absolute Privacy**
    *   *Caption:* "100% private study player. No tracking, no accounts, and works entirely offline."
    *   *Visual:* A beautiful lock icon overlaying a summary of our privacy policy ("No Analytics, No Cloud").
...
1. ON-DEVICE VISUAL WORD SYNC
Read along with active visual guidance. Utilizing WhisperKit (on-device CoreML machine learning), Echo matches the audio file directly to your EPUB text. As the narrator speaks, the current sentence and word highlight on your screen. This dual-input method has been shown to improve reading speed, accuracy, and retention.

2. TAP-TO-SEEK NAVIGATION
Struggled with a paragraph? Don't waste time trying to scrub an audio timeline. Simply tap any sentence in the EPUB text, and the audiobook instantly seeks to that exact spoken word. It makes navigating large study texts as easy as tapping a screen.

3. TAILORED DYSLEXIA-FRIENDLY TYPOGRAPHY
Customize the reader to match your visual comfort. Echo supports full layout adjustments:
- Choose the specialized OpenDyslexic font designed to prevent letter rotation.
...
2.  **Slide 2: Tap-to-Seek Navigation**
    *   *Caption:* "Tap to seek text. Jump directly to any sentence by tapping it in the EPUB."
    *   *Visual:* A finger tapping on a sentence, with a glowing pulse highlighting the sync action.
3.  **Slide 3: Dyslexia-Friendly Fonts**
    *   *Caption:* "OpenDyslexic typography. Customize font size, line spacing, and themes for reading comfort."
    *   *Visual:* Reader view showing EPUB text rendered in the OpenDyslexic font, with the appearance settings sheet open.
4.  **Slide 4: On-Device ML Sync**
...
3. READ ALONG, WORD BY WORD
As the narrator speaks, the current word lights up on screen and the page follows along. Pairing your ears with your eyes aids comprehension and keeps attention from drifting — a real help for ADHD and dyslexic readers.
...
3.  **Slide 3: Read Along, Word by Word**
    *   *Caption:* "Word-by-word read-along. Each word lights up in time with the narration."
    *   *Visual:* The reader with a single word highlighted mid-sentence as the page auto-scrolls.
...
No server? Just load your DRM-free M4B audiobooks and EPUB or PDF companion text straight from Files. Echo aligns the audio to the text on-device so you can read along and study, same as any book.
