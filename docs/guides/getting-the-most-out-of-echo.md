...
**Part two: passive listening still loses on dense material.** Daniel & Woody (2010) gave students the same psychology material as text or as audio. The listeners scored about 28% lower on the quiz — two letter grades' worth. (Most had *preferred* audio beforehand; they changed their minds when the scores came back.) The literature points to two culprits:
