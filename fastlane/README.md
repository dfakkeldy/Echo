...
> + the public link), how the Mac app's second signing certificate works, and how to
> ship the first build, see
...
### ios upload_screenshots_if_available

```sh
[bundle exec] fastlane ios upload_screenshots_if_available
```
