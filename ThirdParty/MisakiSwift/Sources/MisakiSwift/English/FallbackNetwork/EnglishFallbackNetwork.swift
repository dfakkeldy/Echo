...
final class EnglishFallbackNetwork {
  ...
  private static func loadConfig(british: Bool) -> BARTConfig? {
    ...
    guard let url = Bundle.main.url(forResource: fileName, withExtension: "json", subdirectory: "MisakiResources"),
  ...
  private static func loadWeights(british: Bool) -> [String: MLXArray]? {
    ...
    guard let url = Bundle.main.url(forResource: fileName, withExtension: "safetensors", subdirectory: "MisakiResources"),
