...
**Last generated:** 2026-08-16 20:59:30
...
Services/ArticleWorkshop/AnthologyBuildManifestValidator.swift
Services/ArticleWorkshop/AnthologyBuildService.swift
Services/ArticleWorkshop/AnthologyCoverStore.swift
Services/ArticleWorkshop/AnthologyNarrationManifestResolver.swift
Services/ArticleWorkshop/AnthologyService.swift
Services/ArticleWorkshop/ArticleCloudRecordCodec.swift
Services/ArticleWorkshop/ArticleImageDownloader.swift
Services/ArticleWorkshop/ArticleInboxIngestionService.swift
Services/ArticleWorkshop/ArticleInboxService.swift
Services/ArticleWorkshop/ArticleSyncConflictResolver.swift
Services/ArticleWorkshop/ArticleURLCaptureService.swift
Services/ArticleWorkshop/ArticleWorkshopCloudSyncEngine.swift
Services/ArticleWorkshop/BoundedArchiveExtraction.swift
Services/ArticleWorkshop/GeneratedAnthologyImportIdentity.swift
Services/ArticleWorkshop/GeneratedAnthologyImportReconciler.swift
Services/ArticleWorkshop/ReadabilityWebExtractor.swift
...
Services/BlockExportDocument.swift
Services/BlockExportSourceResolver.swift
Services/BookAlignmentSummary.swift
...
Services/ChapteredAudioTimingReader.swift
Services/CloudKitSyncService.swift
Services/CommercialAudioAlignmentSource.swift
...
Services/EstimatedAlignmentSidecar.swift
...
Services/Export/SlideshowFrameLayout.swift
Services/Export/SlideshowFrameRenderer.swift
Services/Export/SlideshowTextFitter.swift
Services/Export/VideoExportDestination.swift
Services/Export/VideoExportService.swift
Services/FeedbackDiagnostics.swift
Services/FeedbackMailBuilder.swift
Services/Library/EditionMatcher.swift
Services/Library/EpubMetadataResolver.swift
Services/Library/LibraryAccess.swift
Services/Library/LibraryCoverStore.swift
Services/Library/LibraryScanner.swift
Services/Library/LibraryService.swift
Services/Library/ReadAlongMergeService.swift
Services/LocationCaptureService.swift
Services/M4BParser.swift
Services/MacCoverTint.swift
...
Services/Narration/AnthologyNarrationStatusService.swift
Services/Narration/AudioFileWriting.swift
Services/Narration/AudioMarkerStub.swift
Services/Narration/BlockVoicePlan.swift
Services/Narration/ChapterVoiceAssignments.swift
Services/Narration/ContextualPronunciationDiscovery.swift
Services/Narration/ContextualPronunciationFamilies.swift
Services/Narration/ContextualPronunciationPreflight.swift
Services/Narration/ContextualPronunciationTypes.swift
Services/Narration/EnglishPronunciationAuditPack.swift
Services/Narration/EnglishPronunciationPack.swift
Services/Narration/EpubCoverResolver.swift
Services/Narration/FMNormalizer.swift
Services/Narration/FoundationModelsContextualPronunciationEvaluator.swift
...
Services/Narration/MisakiPronunciationMarkup.swift
Services/Narration/MisakiResources/us_gold.json
Services/Narration/MisakiResources/us_silver.json
Services/Narration/NarratedBlockText.swift
Services/Narration/NarratedWordAlignment.swift
...
Services/Narration/NarrationChapterRenderPlanner.swift
Services/Narration/NarrationChunkQuality.swift
Services/Narration/NarrationCodeBlockCue.swift
Services/Narration/NarrationCoverOverride.swift
...
Services/Narration/NarrationPlanTrackOffsets.swift
Services/Narration/NarrationPlaybackPlanPreparation.swift
...
Services/Narration/NarrationResumeResolver.swift
Services/Narration/NarrationRunProgressFormatter.swift
...
Services/Narration/NarrationStatusPresentation.swift
Services/Narration/NarrationStatusTypes.swift
...
Services/Narration/NeuralG2P/ARPAbetToKokoroIPA.swift
Services/Narration/NeuralG2P/MiniBARTG2PEngine.swift
Services/Narration/NeuralG2P/MiniBARTG2PTokenizer.swift
Services/Narration/NeuralG2P/NeuralG2PTypes.swift
Services/Narration/NeuralG2PResources/LICENSE
Services/Narration/NeuralG2PResources/config.json
Services/Narration/NeuralG2PResources/decoder_model.onnx
Services/Narration/NeuralG2PResources/encoder_model.onnx
Services/Narration/NeuralG2PResources/generation_config.json
Services/Narration/NeuralG2PResources/tokenizer.json
Services/Narration/OnnxKokoroEngine.swift
Services/Narration/PlannedSynthesisChunk.swift
Services/Narration/ProgressFanOut.swift
Services/Narration/PronunciationAdvisoryEvidence.swift
Services/Narration/PronunciationAdvisoryIssueBuilder.swift
Services/Narration/PronunciationAudit.swift
Services/Narration/PronunciationCandidateAnalyzer.swift
Services/Narration/PronunciationFallbackDiscovery.swift
Services/Narration/PronunciationListeningReel.swift
...
Services/Narration/PronunciationPlanner.swift
Services/Narration/PronunciationRepairService.swift
Services/Narration/PronunciationResources/us_pronunciation_audit_pack.json
Services/Narration/PronunciationResources/us_pronunciation_pack.json
...
Services/Narration/ResolveVoicePlanCommand.swift
Services/Narration/TTSEngine.swift
Services/Narration/TextNormalizer.swift
Services/Narration/UniversalPronunciationResolver.swift
...
Services/PDFFigureExtractor.swift
Services/PDFFigureImporter.swift
...
Services/SidecarImportSummary.swift
Services/SidecarSourceBlockLoader.swift
...
Services/ThumbnailRenderer.swift
...
Utilities/BookTitleFormatter.swift
...
ViewModels/AnthologyBuilderViewModel.swift
ViewModels/AnthologyListViewModel.swift
ViewModels/ArticleCleanupViewModel.swift
ViewModels/ArticleInboxViewModel.swift
ViewModels/ArticleLinkBatchInputParser.swift
ViewModels/ArticleWebsiteCaptureCoordinator.swift
...
ViewModels/MarkedPassageCapture.swift
...
ViewModels/PlayerModel+VisualListeningScope.swift
ViewModels/PlayerModel+WatchState.swift
ViewModels/PlayerModel.swift
ViewModels/ReaderChromeClearance.swift
ViewModels/ReaderFeedViewModel.swift
ViewModels/ReaderFollowState.swift
ViewModels/ReaderWordFollowScroll.swift
...
ViewModels/VisualListeningViewModel.swift
...
Views/ArticleWorkshop/AnthologyBuilderView.swift
Views/ArticleWorkshop/AnthologyDetailView.swift
Views/ArticleWorkshop/AnthologyListView.swift
Views/ArticleWorkshop/ArticleCleanupView.swift
Views/ArticleWorkshop/ArticleDetailView.swift
Views/ArticleWorkshop/ArticleInboxView.swift
Views/ArticleWorkshop/LibraryModePicker.swift
...
Views/Cells/CodeCardCell.swift
...
Views/Components/CoverThemedSheet.swift
Views/Components/DockStatusFeedback.swift
...
Views/SlideshowVideoFormatPicker.swift
...
Views/Stats/DeckLibrarySnapshot.swift
...
Views/StudyLocalImageView.swift
...
Views/VideoExportProgressView.swift
Views/VisualListeningStageView.swift
...
Services/MacImageDecode.swift
Services/MacTranscribeCoordinator.swift
Services/MacVideoExportPublisher.swift
Views/MacAlignmentBadge.swift
Views/MacAnkiExportView.swift
Views/MacAnthologyVoiceEditor.swift
Views/MacArticleWorkshopView.swift
Views/MacAudioExportView.swift
Views/MacAudiobookshelfBrowseView.swift
Views/MacAudiobookshelfView.swift
Views/MacBatchActivityStrip.swift
...
Views/MacPlayerModel+VisualListeningScope.swift
...
Views/MacVideoExportView.swift
Views/MacVisualStageView.swift
...
ArticleCapture/ArticleCaptureEnvelope.swift
ArticleCapture/ArticleCaptureStagingWriter.swift
ArticleCapture/ArticleWorkshopLimits.swift
ArticleWorkshop/AnthologyBuildManifest.swift
ArticleWorkshop/AnthologyCoverRenderer.swift
ArticleWorkshop/AnthologyEPUBBuilder.swift
ArticleWorkshop/AnthologyEPUBPreflight.swift
ArticleWorkshop/ArticleBlockSanitizer.swift
ArticleWorkshop/ArticleImageValidator.swift
ArticleWorkshop/ArticleRevisionMaterializer.swift
ArticleWorkshop/ArticleRevisionService.swift
ArticleWorkshop/ArticleWorkshopFileStore.swift
ArticleWorkshop/ArticleWorkshopModels.swift
ArticleWorkshop/EPUBXMLWriter.swift
ArticleWorkshop/GeneratedAnthologyImportIdentityContract.swift
ArticleWorkshop/LibraryMode.swift
AudioChapterTOCAlignment.swift
BatchQueueRunner.swift
BookProgressSegmentMetrics.swift
BookmarkReviewItem.swift
CardTapDecision.swift
ChapterTitleResolver.swift
ChimeSound.swift
Database/AlignmentAnchorRecord.swift
Database/ArticleWorkshopRecords.swift
...
Database/DAOs/AnthologyDAO.swift
Database/DAOs/ArticleCaptureDAO.swift
Database/DAOs/ArticleSyncDAO.swift
...
Database/Migrations/Schema_V24.swift
...
Database/Migrations/Schema_V35.swift
Database/Migrations/Schema_V36.swift
Database/Migrations/Schema_V37.swift
Database/Migrations/Schema_V38.swift
Database/Migrations/Schema_V39.swift
Database/Migrations/Schema_V40.swift
Database/Migrations/Schema_V41.swift
...
Database/TimelineRowLoader.swift
...
SlideshowExportPlanner.swift
SlideshowVideoDimensions.swift
...
URL+SHA256.swift
VisualListeningCueResolver.swift
VisualListeningImageLocator.swift
...
WatchWidgetProgressProjection.swift
WidgetAccentColor.swift
WidgetPlaybackState.swift
WidgetPlaybackToggleRequest.swift
WordFrequency.swift
...
PrivacyInfo.xcprivacy
Views/EchoCircularWidgetView.swift
Views/EchoRectangularWidgetView.swift
Views/EchoWidgetArtworkView.swift
Views/EchoWidgetEntryView.swift
Views/EchoWidgetPreviews.swift
...
1. **EPUB / Text-Document Import:** When the user adds a companion document, the appropriate parser produces an `EPUBBlockParse` value consumed by a shared persist phase:
   ...
   - **PDF** (`PDFAutoImportScanner`, `EchoCore/Services`) extracts each page's text with **PDFKit** (run off the main actor in a detached task) and feeds the same `EPUBBlockParse` → shared persist phase. Page line breaks are **preserved**, so a standalone "Chapter N" / "Part N" line is still detected as a chapter marker (the same per-line `tokenizePlainText` pass the text path uses); the tokenizer reflows the remaining wrapped lines back into paragraphs. When a marker-less PDF has more than one page, it falls back to **one synthetic narration chapter per page** (`parsePDFPagesAsPlainTextChapters`, `Shared/TextDocumentParser.swift`) so a long PDF doesn't become a single enormous narration batch. **Reachable from** the headless narration runner / `echo-cli narrate`; iOS folder import (a `.pdf` inside an opened folder) and the iOS document picker (`companionDocumentTypes`); and on macOS from both the open panel (opens a PDF as a read-only study book) and **Batch ▸ "Narrate Documents…"**, which queues a standalone `.pdf` for on-device narration via `MacBatchProcessingService.importDocumentOnly`. A macOS folder sweep enqueues `.epub` and `.pdf` (`FolderAudioScanner.narratableDocumentExtensions`); loose `.md`/`.txt` are accepted only as explicit single-file picks, since inside a book folder they are usually notes rather than books.
...
on demand without waiting for the 05:20 America/Halifax nightly / Monday weekly cron, run the
