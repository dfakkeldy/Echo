...
FIGURES = [
    ...
    ("img11", 5, "phone", "Loop modes: chapter, playlist, between bookmarks, or off.",
     "The Playback Options sheet with the loop-mode selector showing all four options, 'Loop chapter' selected."),
    ("img12", 5, "phone", "A bookmark holding a note, a voice memo, a photo, and a place.",
     "Bookmark editor: title, note field, recorded voice-memo waveform, attached photo thumbnail, and an approximate place chip."),
    ...
    ("img27", 11, "phone", "The capture bar: a note or a voice memo, without pausing.",
     "Reader feed with the capture bar active: a note being typed (or hold-to-record mic), playback still running, a captured note threaded into the feed."),
    ...
    ("img34", 15, "mac", "Echo for Mac: bookmarks, player, and document pane.",
     "Mac three-pane window: bookmarks sidebar on the left, the player in the center, the reader pane with live highlighting on the right."),
