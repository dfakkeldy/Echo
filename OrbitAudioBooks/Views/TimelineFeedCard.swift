...
struct TimelineFeedCard: View {
    ...
    private var cardBackground: some View {
        ...
        case .textSegment:       return Color.blue.opacity(0.04)
        case .bookmark:          return Color.orange.opacity(0.04)
        case .ankiCard:          return Color.purple.opacity(0.04)
        ...
        case .imageAsset:        return Color.teal.opacity(0.04)
        }
    }

    private func iconFor(_ type: ContentCardType) -> (name: String, color: Color) {
        switch type {
        case .textSegment:       return ("text.quote", .blue)
        case .bookmark:          return ("bookmark.fill", .orange)
        case .ankiCard:          return ("rectangle.fill.on.rectangle.fill", .purple)
        ...
        case .imageAsset:        return ("photo.fill", .teal)
        }
    }
}
