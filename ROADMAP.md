...
| WS8b | Audiobookshelf integration | ✅ Shipped to `main` (PR #102; V23; connect/browse/search/download-to-local + two-way progress sync). Fast-follows: device-verify live sync, full background-URLSession, multi-server, macOS UI; streaming post-1.0 |
...
| 9 | Audiobookshelf Integration | ✅ Shipped to `main` (PR #102; connect/browse/search/download/progress-sync; V23; live-sync device-verify + streaming deferred post-1.0) |
