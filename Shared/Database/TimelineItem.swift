...
nonisolated enum TimelineItemType: String, Codable {
    case textSegment
    case chapterMarker
    case imageAsset
    case bookmark
...
nonisolated enum GranularityLevel: Int, Codable {
    case chapter = 0
    case paragraph = 1
    case sentence = 2
    case word = 3
...
nonisolated struct TimelineItem: Identifiable, Equatable, Codable, FetchableRecord, MutablePersistableRecord {
    var id: String
