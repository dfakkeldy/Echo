...
struct AutoAlignmentTextMatcherTests {
    ...
    @Test func continuousMatcherNeverMatchesCodeCandidate() {
        let code = EPubBlockRecord(
            id: "code", audiobookID: "book", spineHref: "ch.xhtml",
            spineIndex: 0, blockIndex: 0, sequenceIndex: 0,
            blockKind: EPubBlockRecord.Kind.code.rawValue,
            text: "sentinel syntax tokens", chapterIndex: 0, isHidden: false)

        let result = AutoAlignmentTextMatcher.findBestMatch(
            transcribedText: "sentinel syntax tokens",
            candidates: [code],
            matchThreshold: 0)
    ...
    @Test func shortTranscriptMatchesWindowInsideLongParagraph() throws {
        ...
        let candidates = [
            EPubBlockRecord(
                id: "wrong", audiobookID: audiobookID, spineHref: "ch1.xhtml",
                spineIndex: 0, blockIndex: 0, sequenceIndex: 0,
                blockKind: "paragraph",
                text: "The meadow was quiet and the morning train had not yet arrived.",
                chapterIndex: 0, isHidden: false),
            EPubBlockRecord(
                id: "right", audiobookID: audiobookID, spineHref: "ch1.xhtml",
    ...
    @Test func bestWindowStartReportsBlockTokenPositionOfBestMatchingWindow() throws {
        ...
        let candidates = [
            EPubBlockRecord(
                id: "b", audiobookID: "book", spineHref: "ch.xhtml",
                spineIndex: 0, blockIndex: 0, sequenceIndex: 0,
                blockKind: "paragraph",
